...
{ Entity entity, Map<String, Object> bindings, Event event = null ->
    ...
    def pos = new Vector(entity.getProperty("x"), entity.getProperty("y"))
    def size = new Vector(entity.getProperty("width"), entity.getProperty("height"))
    def center = pos.add(size.multiply(0.5))
